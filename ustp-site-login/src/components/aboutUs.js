...
import jushuaImage from '../Resources/jushua.png';
...
function AboutUs() {
  return (
    <div className="App">
            ...
            <div className="col-sm-6 col-md-6 col-lg-3 mb-sm-4">
              <div className="card text-center bg-light" style={{ height: "100%" }}>
                <div className="card-body d-flex flex-column align-items-center justify-content-center">
                  <img
                    src={jushuaImage}
                    className="rounded-circle img-fluid" // Added img-fluid class for responsiveness
                    alt="Jushua Pabelic"
                    style={{ width: "150px", height: "150px", objectFit: "cover" }} // Adjusted width and height
                  />
      ...
      <br />
      <Link to="/userDetails" className="btn btn-primary mb-3">
        Back
      </Link>
